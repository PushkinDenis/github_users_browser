(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))a(r);new MutationObserver(r=>{for(const c of r)if(c.type==="childList")for(const n of c.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&a(n)}).observe(document,{childList:!0,subtree:!0});function t(r){const c={};return r.integrity&&(c.integrity=r.integrity),r.referrerPolicy&&(c.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?c.credentials="include":r.crossOrigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function a(r){if(r.ep)return;r.ep=!0;const c=t(r);fetch(r.href,c)}})();const d=()=>`<div class="search">
    ...
    <div class="user-card__col">
      ...
      <div class="user-card__url user-card__prop">${e.html_url}</div>
    </div>
    <div class="user-card__col">
  ...
  </div>`),v=e=>{const s=document.querySelector(".user-card__container");if(s===null){const t=document.createElement("div");t.className="user-card__container";const a=document.querySelector(".application-main");t.innerHTML=e,a.prepend(t)}else s.innerHTML=e},p=e=>{if(document.querySelector(".user-list")===null){const t=document.createElement("div");t.className="user-list__container";const a=document.querySelector(".application-main");t.insertAdjacentHTML("afterbegin",e),a.append(t)}else document.querySelector(".application-main").insertAdjacentHTML("afterbegin",e)},m=async e=>await(await fetch(`https://api.github.com/users/${e}`)).json(),h=async()=>await(await fetch("https://api.github.com/users")).json(),f=()=>{let e={};const s=document.querySelectorAll(".search__button");for(let t of s)t.addEventListener("click",a=>{const n=a.target.previousElementSibling.firstElementChild.value;n!==""&&m(n).then(i=>{e={login:i.login,id:i.id,avatar_url:i.avatar_url,html_url:i.html_url,name:i.name,location:i.location};const l=o(e);v(l)})})},b=()=>{const e=document.querySelector(".nav-bar__users");let s=[];e.addEventListener("click",()=>{h().then(t=>{s.push(t);for(let a of s[0]){a={login:a.login,id:a.id,avatar_url:a.avatar_url,html_url:a.html_url,name:a.name,location:a.location};const r=o(a);p(r)}})})};_();f();b();
